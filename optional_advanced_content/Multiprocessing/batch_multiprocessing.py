...
@descript:  A cleaned version of the batch segmentation pipeline, ready for 
            multiprocessed execution. For further information, please see
...
def pipeline(filename):
    ...
    # Check if input filename exists, else return an error
...
#    plt.show()
    ...
    # Return result as tuple (important in multiprocessing)
