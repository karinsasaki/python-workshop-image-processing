...
@authors:   Created by Jonas Hartmann @ Gilmour Group @ EMBL Heidelberg
...
@descript:  This is an example pipeline for the segmentation of 2D confocal
            ...
            automated image processing and segmentation in Python. 
...
# (i) Let's get you started: Using the import command as above, import:
